...
export class PublicationsFileFactory {
    constructor(trustedCertificates = PUBLICATIONS_FILE_SIGNATURE_CONSTANTS.TrustedCertificates, signatueSubjectToVerify = PUBLICATIONS_FILE_SIGNATURE_CONSTANTS.GuardtimeSignatureSubjectEmail) {
