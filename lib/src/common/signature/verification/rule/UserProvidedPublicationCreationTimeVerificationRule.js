    ...
    verify(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return aggregationTime.geq(userPublicationTime)
                ? new VerificationResult(this.getRuleName(), VerificationResultCode.NA, VerificationError.GEN_02(new KsiVerificationError('User publication is created before signature.')))
