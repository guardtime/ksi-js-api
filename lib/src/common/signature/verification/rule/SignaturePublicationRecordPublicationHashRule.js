 ...
 */
var SignaturePublicationRecordPublicationHashRule = /** @class */ (function (_super) {
    __extends(SignaturePublicationRecordPublicationHashRule, _super);
...
export { SignaturePublicationRecordPublicationHashRule };
