 ...
 */
var AggregationHashChainMetadataRule = /** @class */ (function (_super) {
    __extends(AggregationHashChainMetadataRule, _super);
                ...
                for (_i = 0, aggregationHashChains_1 = aggregationHashChains; _i < aggregationHashChains_1.length; _i++) {
                    ...
                    for (_a = 0, _b = chain.getChainLinks(); _a < _b.length; _a++) {
                        ...
                        if (paddingTag === null) {
                            ...
                            hashAlgorithm = HashAlgorithm.getById(hashAlgorithmId);
...
export { AggregationHashChainMetadataRule };
