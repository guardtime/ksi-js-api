 ...
 */
var AggregationHashChainIndexSuccessorRule = /** @class */ (function (_super) {
    __extends(AggregationHashChainIndexSuccessorRule, _super);
...
export { AggregationHashChainIndexSuccessorRule };
