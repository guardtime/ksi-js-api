    ...
    verify(context) {
        return __awaiter(this, void 0, void 0, function* () {
            return context.getUserPublication() === null
                ? new VerificationResult(this.getRuleName(), VerificationResultCode.NA, VerificationError.GEN_02(new KsiVerificationError('User publication is missing from context.')))
