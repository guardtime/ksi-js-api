 ...
 */
var InternalVerificationPolicy = /** @class */ (function (_super) {
    __extends(InternalVerificationPolicy, _super);
    function InternalVerificationPolicy() {
        ...
        new CalendarAuthenticationRecordExistenceRule() // Gen-02
            ...
            .onNa(new SuccessResultRule()))))) || this;
    }
...
export { InternalVerificationPolicy };
